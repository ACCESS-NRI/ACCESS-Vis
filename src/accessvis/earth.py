...
def plot_region(lv=None, cropbox=None, vertical_exaggeration=10, texture='bluemarble', lighting=True, when=None, waves=False, blendtex=True, bathymetry=False, name='surface', uniforms={}, shaders=None, background='black', *args, **kwargs):
    """
